...
class ItemAdapter(private val mItems: List<Item>, private val mLayoutManager: GridLayoutManager) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        ...
        return if (viewType == VIEW_TYPE_BIG) {
            val view = inflater.inflate(R.layout.item_big, parent, false)
            ItemViewHolder(view, viewType)
        } else {
            val view = inflater.inflate(R.layout.item_small, parent, false)
            ItemViewHolder(view, viewType)
        }
    }
